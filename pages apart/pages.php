 ...
 * Order by Kove Wong
 */
 $link=mysql_connect('localhost','root','inet360');
...
<?php
 ...
 $key.="<span style='color:#000000;'>第一页 </span>";//第一页
 $key.="<span style='color:#000000;'>上一页</span>"; //上一页
}
 if($pages>$page_len){
 //如果当前页小于等于左偏移
 if($page<=$pageoffset){
 ...
 if($i==$page){
 $key.=' <span style="color:#000000;">'.$i.'</span>';
 } else {
 ...
 $key.="<span style='color:#000000;'> 下一页 </span>";//下一页
 $key.="<span style='color:#000000;'>最后一页</span>"; //最后一页
 }
 $key.='</div>';
?>
 <tr>
